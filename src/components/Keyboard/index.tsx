...
const Keyboard = () => {
  ...
  return (
    <div className="flex fixed mx-auto bottom-28 md:bottom-20 flex-col items-center gap-1">
      {keycaps.map((row, i) => (
        <div className="flex gap-1" key={`keyboard-row-${i}`}>
          {row.split(",").map((keycap) => {
            ...
            return (
              <button
                ...
                className={`border rounded-md font-bold text-3xl md:text-2xl uppercase font-mono px-2 hover:-translate-y-1 ${keyclass}`}
              >
